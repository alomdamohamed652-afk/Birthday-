...
window.BIRTHDAY_CONFIG = {
  ...
  photos: {
    ...
    items: [
      { image: "", title: "صورة أولى", caption: "حطي الصورة هنا لما تكوني جاهزة. ♡" },
      { image: "", title: "لحظة حلوة", caption: "صورة تفضل فاكرة بيها اليوم ده." },
      { image: "", title: "ذكرى صغيرة", caption: "تفصيلة بسيطة، بس تستاهل تتحفظ." },
      { image: "", title: "صورة أخيرة", caption: "مكان لصورة ليها معنى خاص. ♥" }
    ]
  },
